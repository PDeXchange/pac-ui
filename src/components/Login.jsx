...
const Welcome = () => {
  ...
  return (
   ...
   <br/>
        ...
        <p>Click <strong>Register</strong> to get started. You'll need a valid <a href="https://www.ibm.com/account/us-en/signup/register.html" target="_blank" rel="noopener noreferrer">IBMid</a> or <a href="https://github.com/join" target="_blank" rel="noopener noreferrer">GitHub</a> account to complete the registration. If you've already registered, click <strong>Log in</strong> to go directly to the PAC dashboard. 
</p>
<br/>
